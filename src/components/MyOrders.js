        ...
        <div className='my_orders_container'>
            <div className='my_orders_center_container'>
                ...
                <div className='order_search_container'>
                    <input className='order_search' placeholder='Search by product name'></input>
                    <button type="submit" className='order_search_button'><i class="fa fas-search" aria-hidden="true"></i></button>
                </div>
                ...
                <div className='order_item_container'>
                    ...
                    <div className='order_item_info_container'>
                        ...
                        <div className='order_item_name_container'>
                            <p className='order_item_name'>Tag Heuer Aquaracer professional 300 stainless steel bracelet watch</p>
                            <p className='order_item_qty'>Qty: 1</p>
                            <a href="#" className='buy_again_link'>Buy it again</a>
                        </div>
