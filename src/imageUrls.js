// store all your watch images on imgur
// export the links with the DIRECT LINK choice
// so that you get the .png extension
// dump them in an array
// export them
// import them elsewhere for use
// or, iterate over these values when you seed
...
export const imageUrls = [
  ...
  'https://i.imgur.com/cvqE34m.png?1',
...
/* 
   ...
   just do imageUrls.map((url, idx) => <img src={url} key={idx} alt={'watch-image'} />)
